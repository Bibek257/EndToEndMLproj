...
class DataTransformation:
    """
    Class for creating and applying data transformations.
    """
    def __init__(self):
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """
        Loads datasets, applies preprocessing, and saves the preprocessor object.
        """
        try:
            ...
            return train_arr, test_arr, self.data_transformation_object.preprocessor_obj_file_path
